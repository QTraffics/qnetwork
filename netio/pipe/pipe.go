...
// Set sets the point in time when the pipe will time out.
// A timeout event is signaled by closing the channel returned by waiter.
// Once a timeout has occurred, the pipe can be refreshed by specifying a
...
func (d *Deadline) Set(t time.Time) {
	...
	// Time is zero, then there is no pipe.
...
// Wait returns a channel that is closed when the pipe is exceeded.
