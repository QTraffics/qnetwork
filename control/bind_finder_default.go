...
func (f *DefaultInterfaceFinder) ByName(name string) (*Interface, error) {
	...
	return nil, &net.OpError{Op: "route", Net: "ip+net", Source: nil, Addr: &net.IPAddr{IP: nil}, Err: ex.New("no such network interface")}
}
...
func (f *DefaultInterfaceFinder) ByAddr(addr netip.Addr) (*Interface, error) {
	...
	return nil, &net.OpError{Op: "route", Net: "ip+net", Source: nil, Addr: &net.IPAddr{IP: addr.AsSlice()}, Err: ex.New("no such network interface")}
}
